export enum PrayerRequestCardTestIds {
  ...
  prayedButton = "prayer-request-card-prayed-button",
  requestTitle = "prayer-request-card-request-title",
  requestDescription = "prayer-request-card-request-description",
}
